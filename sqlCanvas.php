...
<body>
                ...
                <div class="container grid px-6 mx-auto">
                    ...
                    <div class="sql-canvas">
                        <form action="sqlCanvas.php" method="get">
                            ...
                            <label for="message"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Sql command
                                (use CRTL+SPACE for hints)</label>
                            <textarea name="sql_query" id="sql-canvas"
    ...
    <script>// Define custom SQL keywords for autocomplete
 var customSqlKeywords = ["SELECT", "UPDATE", "INSERT INTO", "DELETE FROM", "CREATE TABLE", "DROP TABLE",
