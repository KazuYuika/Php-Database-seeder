            ...
            <li class="relative px-6 py-3">
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    ...
                    while ($row = $response->fetch_assoc()) {
                        ...
                        echo "<li><a class='flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' href='showTables.php?database={$selectedDatabase}&table={$row['Tables_in_'. $selectedDatabase]}'>{$row['Tables_in_'. $selectedDatabase]}</a></li>";
                    }
                 ?>
                </ul>
            </li>
