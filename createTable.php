...
<body>
    ...
    //             const addColumnButton = document.querySelector('button[name="add_column"]');

    //     const columnsContainer = document.querySelector('.grid.md\\:grid-cols-6.md\\:gap-6');

    //     addColumnButton.addEventListener('click', function() {
    //         // Clone the first column set as a template
    //         const newColumn = columnsContainer.firstElementChild.cloneNode(true);

    //         // Clear the input values in the cloned set
    //         newColumn.querySelectorAll('input').forEach(input => input.value = '');
    //         newColumn.querySelector('select').selectedIndex = 0;

    //         // Append the new column set to the container
